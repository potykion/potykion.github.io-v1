...
- [/dev/py/test](/dev/py/test): Шпаргалка по тестированию
- [/dev/dict_to_json](/dev/dict_to_json): Конвертер питоновских словарей в json

## 3.6.0 - 2022-04-12

- [/n/reviews](/n/reviews): Книга отзывов и предложений: что мне пишут незнакомые люди
- [/archive](/archive): Архив на главной
- Фиксы поехавшей верстки
- Отзыв можно оставить [анонимно](https://new.donatepay.ru/@potyk)
...
- [/dev/postman](/dev/postman): Кидаем запросики с Postman
...
- [/food/home/breakfast](/archive/food/home/breakfast): **Завтраки** - оч доволен как хорошо статеечку написал: много текста ~~мало теста~~, стилизовочка приколядры *(хотя приколяндр мало)* 

---

## 2.10.0 - 2021-09-05 

- [/food/outside/mendel](/archive/food/outside/mendel): Про Менделеевскую: про шаурму и пониженную социальную ответственность
...
- Новое [меню](/)
- Новый раздел ["Про еду"](/archive/food) - теперь это не просто свалка рецептов, а свалка рецептов, разбитая по категориям
...
- [/food](/archive/food): База + пара новых рецептиков
...
- [/food](/archive/food): Тир-листы еды
...
- [/food](/archive/food): Свалка рецептов
