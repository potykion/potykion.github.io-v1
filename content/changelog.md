...
- [/dev/vue/ceo](/dev/vue/ceo): Семантическая верстка (бтв так лень ее тут делать, тк хз че пользователю интересно, если ты это читаешь, [напиши мне](https://t.me/potykion) что тебе интересно)
- [/dev/python/bio](/dev/python/bio): Пара слов про опыт в бекенд разработке
