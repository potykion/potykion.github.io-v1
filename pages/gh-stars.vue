<template>
  <article>
    ...
    <p class="border-2 p-2 rounded">
      <b>UPD:</b> Я разбил либы на технологии и на отдельные страницы, здесь осталось то, что не попало на другие
      страницы и скоро будет так же разбито на маленькие странички
    </p>
