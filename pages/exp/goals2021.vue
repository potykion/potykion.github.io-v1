<template>
  <article>
    ...
    <ul>
      ...
      <li>2021-06-05 начал вести базу знаний по инглишу <nuxt-link to="/exp/eng/articles">в блоге</nuxt-link></li>
    ...
    <ul>
      ...
      <li>
        <spoiler>
          ...
          <template slot="spoiled">
            <p>На текущей работе ничего не держит: бабос могу получать больше, в офисе часто ничего не происходит, задач бывает нет.</p>
            <br>
