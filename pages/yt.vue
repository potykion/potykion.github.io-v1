<template>
  ...
  <article>
    ...
    <img-row :images="['/yt/channels.png']"></img-row>
    ...
    <section>
      ...
      <img-row :images="['/yt/humor.jpg']"></img-row>
      ...
      <img-card img="/yt/xaa.png" :streamline="true">
        <p>
      ...
      <p>
        ...
        жанра почти не осталось, так как жанр мертв, но парочку укажу: <a
        href="https://www.youtube.com/watch?v=CtxI0rCBJwg">Adeq</a>, <a
        href="https://www.youtube.com/watch?v=Mkq8NI9bfNE">multiprogramm</a>, <a
        href="https://www.youtube.com/user/niggacommunist">niggacommunist</a> (последний является автором таких
        популярных
        мемов как <a href="https://www.youtube.com/watch?v=Y-aXG94nmLo">ДИСКО ЕБАЛО</a> и <a
        href="https://www.youtube.com/watch?v=pP3guab-KVs">всем офисом ржем в вотссаппе</a>).
      </p>

      <!--    todo refactor with img-card -->

      <img src="~/assets/yt/atmta.png" class="streamline-img float-right" alt="Всякая Атмта">

      <p>
        Это дело форсилось в ВК в паблосе <a href="https://vk.com/hynta_atmta"><b>Всякая Атмта</b></a>. Как следует из
        названия,
        паблос форсил всякие мемы, в основном связанные с играми, оттуда выросли паблосы с мемами про <a
        href="https://vk.com/enciar">
        Fallout</a>, с мемами <a href="https://vk.com/deus_ex_meme"> про киберпанк для самых маленьких</a>, любой паблос
        с
        мемами про популярную игру растет +- оттуда. Еще там я узнал о паре yt-каналах про игрушки - <a
        href="https://www.youtube.com/user/CrowbCat">Crowbcat</a> - сравнение игр, напр. на тизере и на релизе (<a
        href="https://www.youtube.com/watch?v=omyoJ7onNrg">про киберпук</a> просто пушка) и <a
        href="https://www.youtube.com/user/MrShpigun">Шпигун</a> - смешные обзорчики игрушек (на самом деле я узнал о
        нем раньше, тк он связан с тусовкой RJеев MaddysonFM).
      </p>


      <img src="~/assets/yt/gm.png" class="streamline-img float-left" alt="Garry's Mod">


      <p>
        Немаловажную часть игровой мем культуры (пиздец сказанул) составляют мемы про <a
        href="https://vk.com/valvememes">игры
      ...
      <img src="~/assets/yt/mashup.png" class="streamline-img float-right" alt="Mashup">

      <p>
        Среди неигровых форсов Всякой Атмты хочется отметить такой пабос как <a
        href="https://vk.com/mashup"><b>#mashup</b></a>.
      ...
      <p class="italic">
        Я незнаю почему ты читаешь рэп.<br/>
      ...
      <p>
        ...
        -
        <a href="https://www.youtube.com/watch?v=CzpQxmPiRvE">Смешариков мешают с Linkin Park</a>. Такое популярное
        явление как <a href="https://www.youtube.com/watch?v=POb02mjj2zE">Gachi-миксы</a> в России расфорсилось не без
        помощи этого паблоса. Еще там постят <a href="https://www.youtube.com/channel/UCgISDXr5ZVZzTPnFYSMXTVA">#Качественный
        Саунд</a> - дикая смесь большого количества сурсов с драм энд бейсом.
      </p>
      ...
      <img src="~/assets/yt/peplix.png" class="streamline-img float-right" alt="Пепликсы">


      <p>
        В 2019 году в мем игру ворвался паблос <a href="https://vk.com/peplix"><b>мемблексы
        от пепликсов</b></a>. Суть та же: запускается форс, потом фотошопиться в куче всяких вариаций сообществом,
        получается
        большая ржака. Однако, помимо фотошопов, здесь ебашут контент с использованием моушн-дезигна, чего стоит <a
        href="https://vk.com/video-134304854_456240280">реклама сосательных конфет БОБС</a> от <a
        href="https://vk.com/aminoacid">админа</a>.
        Также они дают вторую жизнь старым добрым приколам, напр. Денчик слазиет и <a
        href="https://www.youtube.com/channel/UCopMiHFAAp5fcow9h5lg-Mg">Ну как
        там с деньгами?</a>.
      </p>


      <img src="~/assets/yt/humas.png" class="streamline-img float-left" alt="Хумас">


      <p>
        На основе всего этого рос я и другие представители молодежи. Самым любимым из них для меня является
        <a href="https://www.youtube.com/channel/UCdga1n7C6EJfoS0lYxDpeoA"><b>Хумас</b> </a> - в нем сочетается все, что
        я
        описал
      ...
      <p>
        ...
        href="https://www.youtube.com/channel/UC4m-Z-MOiz-egKShl9OcJRQ">Novak</a>, <a
        href="https://www.youtube.com/channel/UC1DjDHroLdWawdNj7EJi7xg">Демьян</a>, <a
        href="https://www.youtube.com/channel/UClGmWE9J0jQVwiiATgNe-YA">Ramson</a>, <a
        href="https://www.youtube.com/channel/UC5Aln3eK41wovAQggcQj0dQ">Мемут</a>. Последний уже своих друзей пиарит: <a
        href="https://www.youtube.com/watch?v=3qRKBjlh_hg">M1shel</a>, <a
      ...
      <img src="~/assets/yt/twitch.png" class="streamline-img float-right" alt="Чвич">
      ...
      <img src="~/assets/yt/stream.png" class="streamline-img float-left" alt="Струмушка">
      ...
      <p>
        ...
        каналы, которые занимаются нарезками, напр. <a
        href="https://www.youtube.com/channel/UC0t8dMh13Rl-I-dbBlR0vFA">Стримушка</a> - там показывают яркие
        моменты таких стримеров как вышеупомянутые Lasqa и Faker, а так же <a href="https://www.twitch.tv/c_a_k_e">C_a_k_e</a>,
        <a
          href="https://www.twitch.tv/voodoosh">Voodoosh</a>, <a
        href=" https://www.twitch.tv/karmikkoala">KarmikKoala</a> и много других.
        Еще про стримеров делают <a href="https://yadi.sk/i/5Uj-7vn3K_V3HA">целые
        мувики</a>.
      </p>
      ...
      <ul>
        <li>
          <a href="https://www.youtube.com/channel/UCoTJydABhshW-N_h_tN9rrQ">Vansamaofficial</a> - нарезки со стримов
          ВЕНА
    ...
    <section>
      ...
      <p>Как разраб я смотрю много каналов, связанных с айти.</p>

      <h3>Не супер хардкор</h3>

      <p>Здесь опишу каналы, в которых мало кода и много болтовни:</p>

      <ul>
        <li><a href="https://www.youtube.com/channel/UCr9qCdqXLm2SU0BIs6d_68Q">yegor256 a.k.a. Yegor Bugayenko</a> -
          канал
        ...
        <li>
          <a href="https://www.youtube.com/channel/UCUSbYJK87rpBUJ5KGQd7oHA">Мы обречены</a> - подкаст с известными
          личностями из айти на разные темы, зачастую несвязанными с айти
        </li>
        <li>
          <a href="https://www.youtube.com/user/99baddawg">Ben Awad</a> - ~20-летний чел делает прикольные проекты и
          рассказывает кулстори про них, напр. расширение для VSCode для поиска пары - <a
          href="https://www.youtube.com/watch?v=bfd8RyAJh6c">VSinder</a>
        </li>

        <li>
          <a href="https://www.youtube.com/channel/UC9hBi-d-CKFU55XRd1JP3LA">IT.Высер</a> - ведущий встречается с
          айтишным
        ...
        <li>
          ...
          технологии обучающего характера; есть постоянная рубрика "X за 100 секунд", где, как следует из названия,
          расказывается про технологию за
      ...
      <p>
        ...
        нему делается много видео контента - на <a href="https://www.youtube.com/channel/UCwXdFgeE9KYzlDdR7TG9cMw">офф
        канале</a> ~200 видосов за 2 года.
      </p>

      <ul>
        <li>
          <a href="https://www.youtube.com/channel/UCSIvrn68cUk8CS8MbtBmBkA">Reso Coder</a> - оч крутые туториалы +
          обзоры либ, так же есть <a href="https://www.youtube.com/playlist?list=PLB6lc7nQ1n4iYGE_khpXRdJkJEp9WOech">плейлист</a>
          про то как построить чистую архитектуру.
        </li>
        <li>
          <a href="https://www.youtube.com/channel/UCU8Mj6LLoNBXqqeoOD64tFg">Fun with Flutter</a> - аналог ResoCoder -
          туториалы + обзоры либ
        </li>

        <li>
          <a href="https://www.youtube.com/user/Firebase">Firebase</a> - новости, туториалы по Firebase - BAAS решение
          от
          гугла, которое плотно интегрирунтся с Flutter.
        </li>

        <li>
          <a href="https://www.youtube.com/user/GoogleDevelopers">Google Developers</a> - видосы с конференций,
          туториалы и новости от гугла для разрабов, в тч про Flutter
        </li>
        ...
        <li>
          <a href="https://www.youtube.com/channel/UC_a-vGdkAIRMKT1zzZ4I2ag">FlutterLDN</a> - докладики с конфы по
          Flutter
          - FlutterLDN
        </li>
      </ul>
      ...
      <ul>
        <li>
          <a href="https://www.youtube.com/user/moscowjs">MoscowJS</a>
        </li>
        <li>
          <a href="https://www.youtube.com/channel/UCp4bYTGrxZ27ifRxm29U5ow">MSK VUE.JS</a>
        </li>
        <li>
          <a href="https://www.youtube.com/channel/UCN9aK6ZG5PS1nnJZqscsmKw">PiterJS</a>
        </li>
        <li>
          <a href="https://www.youtube.com/c/PiterPy/videos">PiterPy</a>
        </li>

        <li>
          <a href="https://www.youtube.com/user/videoitpeople">Василий Айтипиплов</a> (PyCon Russia, DUMP)
        </li>

        <li>
          <a href="https://www.youtube.com/user/404fest">404fest</a>
        </li>


        <li>
          <a href="https://www.youtube.com/channel/UCO2w0cpl1wxygHjQH6eEfEg">AvitoTech</a>
        </li>
        <li>
          <a href="https://www.youtube.com/user/codefestru">CodeFest Russia</a>
        </li>

        <li>
          <a href="https://www.youtube.com/channel/UC1nDIT9thqoFSSxvLyPHF5w">DevOps Channel</a>
        </li>
        <li>
          <a href="https://www.youtube.com/channel/UCGQRn0aTnJK-zHFAdT9Nm1A">Frontend Channel</a>
        </li>


        <li>
          <a href="https://www.youtube.com/channel/UCxKXx-eVWNib87Wst7nv_KQ">GDG Russia</a>
        </li>
        <li>
          <a href="https://www.youtube.com/user/profyclub">HighLoad Channel</a>
        </li>

        <li>
          <a href="https://www.youtube.com/channel/UCP8MtCo2ZcrJc7_Zhcjym9g">Mobile Channel</a>
        </li>


        <li>
          <a href="https://www.youtube.com/channel/UCCLC8dta4gbG9aCM5ynRIrw">Management Channel</a>
        </li>
        <li>
          <a href="https://www.youtube.com/channel/UCCqNFXg3NRbRA6qNKFRecdw">Ozon IT Events</a>
        </li>
        <li>
          <a href="https://www.youtube.com/channel/UC7hjrpB81FSipI1oqtOaZqQ">RITFest Channel</a>
        </li>
    ...
    <section>
      ...
      <ul>
        ...
        <li>
          <a href="https://www.youtube.com/channel/UCmZTf9kzdx3KqYC7NZROknQ">Ritartha</a> - девушка интересно рассуждает
          на темы философии, культуры, политики, напр. что <a href="https://www.youtube.com/watch?v=TbF69VYRJJ4">Варламов
          -
          лох</a>
        </li>
        <li>
          <a href="https://www.youtube.com/channel/UC28GNXIYdBiI1zTBySZEoRw">Bookademy</a> - обзоры нонфикшн книг
        </li>
        <li>
          <a href="https://www.youtube.com/channel/UCNSkhjIGs63VfGVLQQu2bzA">Хулиномика</a> - канал автора книги
          Хулиномика;
          описание канала лучше меня о нем скажет:<br>
          <i>Как принимать правильные решения. Как принимать на грудь. Как жить. Как не надо.</i>
          <br>
          Еще у него есть
          <a href="https://www.youtube.com/user/GoblinWarchief">доп канал с обзорами книг</a>.
        </li>
        <li>
          <a href="https://www.youtube.com/channel/UCI_10IRftFes3lxlTVEjTzg">RationalAnswer</a> - принятие решений,
          инвестиции и все такое - тематика контента примерна похоже на Хулиномику
        </li>
        ...
        <li>
          <a href="https://www.youtube.com/user/MultiDepr">Депрсна</a> - атмосферныеее вью с андерами
        </li>
