<template>
  ...
  <div>
    ...
    <hr />
    <h2 class="text-center">🛠 ВОРК ИН ПРОГРЕСС 🛠</h2>
    <hr />
...
<!--    </ul>-->
    ...
    <p>
      ...
      href="https://www.youtube.com/user/niggacommunist">niggacommunist</a> (последний является автором таких популярных
...
<!--    todo refactor with img-card -->
    ...
    <p>
      ...
      Fallout</a>, с мемами <a href="https://vk.com/deus_ex_meme"> про киберпанк для самых маленьких</a>, любой паблос с
    ...
    <p>
      ...
      Идея проста - мешать 2 или больше трека в один, но пабос вскрыл целый пласт мемов про музыку. Например есть такой
      репер как 1kla$, тексты песен которого звучат так:
    </p>
    ...
    <p>
      ...
      <a href="https://www.youtube.com/channel/UCdga1n7C6EJfoS0lYxDpeoA"><b>Хумас</b> </a> - в нем сочетается все, что я
      описал
      я выше: сложный монтаж, а ля ХААРАКТЕР; работа в г-моде + фотошопе; куча мемов; смешные словечки и фразочки, типа
    ...
    <ul>
      ...
      <li>
        <a href="https://www.youtube.com/channel/UCiQo406SKypmtAQXIHdZ6mA">birchpunk</a> - <a
        href="https://www.youtube.com/watch?v=8HZ4DnVfWYQ">РУССКАЯ КИБЕРДЕРЕВНЯ</a>
      </li>
      <li>
    ...
    <ul>
      ...
      <li>
        <a href="https://www.youtube.com/channel/UCSIvrn68cUk8CS8MbtBmBkA">Reso Coder</a> - оч крутые туториалы по
        Flutter + обзоры либ
      </li>
      <li>
